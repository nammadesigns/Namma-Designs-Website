...
import { getActiveOffers, LocalOffer as Offer } from "../lib/localStorageService";
      ...
      <header className="bg-white sticky top-0 z-50 shadow-md">
        <nav className="container mx-auto px-4 sm:px-6 py-4 flex justify-between items-center max-w-7xl">
          <Link to="/" className="flex items-center space-x-2 sm:space-x-3">
            <img src="https://i.postimg.cc/mgFj0v2P/Namma-Designs-Logo.jpg" alt="Namma Designs Logo" className="w-8 h-8 sm:w-10 sm:h-10" />
      ...
      <footer className="bg-white border-t py-6 sm:py-8">
        <div className="container mx-auto px-4 sm:px-6 text-center max-w-7xl">
          <div className="flex items-center justify-center mb-3 sm:mb-4">
            <img src="https://i.postimg.cc/mgFj0v2P/Namma-Designs-Logo.jpg" alt="Logo" className="w-6 h-6 sm:w-8 sm:h-8 mr-2" />
